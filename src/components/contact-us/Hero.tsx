import bg from "../about-us/about-us-bg.png";
import bgMobile from "../about-us/about-us-bg-mobile.png";
...
function SocialMediaLink({
  ...
  return (
    <a
      className="flex items-center gap-4 text-white hover:opacity-80 transition-opacity duration-150"
      href={href}
    >
      {icon}
    ...
    <div className="flex flex-col md:flex-row p-4 lg:p-28 justify-center items-center gap-12 lg:gap-20">
      ...
      <div className="grow flex flex-col bg-primary gap-4 py-10 px-6 rounded-lg">
        ...
        <SocialMediaLink
          ...
          text="UBC BIOMOD"
          href="https://www.linkedin.com/company/ubc-biomod/"
        />
        <SocialMediaLink
          icon={
            <svg
