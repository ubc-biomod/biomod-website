...
const BecomeASponsor: React.FC = () => {
  return (
    ...
    <div className="w-4236 h-1496 shrink-0">
      ...
      <div className="mt-67 w-3328 h-312 text-[32px] font-sans font-normal">
        <p className="text-center" >The success of our previous years was only made possible due to generous sponsors like you.</p>
      </div>
    
    </div>
 
    <div className="w-4696 h-2116 bg-slate-300 rounded-2xl flex-row"></div>
    <div className="">
    </div>
    ...
    <div className="w-4536 h-1760 shrink-0">
      ...
      <br/>
        <div className="w-2108 h-1204 grid grid-cols-2 gap-10 content-start text-center text-[16px] font-normal leading-6">
          ...
          <div ><p> Want to support our cause? Become a sponsor! Our strong performances in previous BIOMOD competitions wouldn't be possible without sponsors like you.</p>
            <br/>
      ...
      <footer className="w-5120 h-328 bg-slate-500"></footer>
